...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        // Added `relative` for the grid background
        // Changed background to `bg-black`
        "relative max-w-sm w-full mx-auto p-8 rounded-xl border border-white/[0.2] bg-black shadow-2xl group",
        className
      )}
    >
      {/* Grid background */}
      <div className="absolute inset-0 h-full w-full bg-transparent [background-image:linear-gradient(to_right,theme(colors.neutral.800)_1px,transparent_1px),linear-gradient(to_bottom,theme(colors.neutral.800)_1px,transparent_1px)] [background-size:2rem_2rem] z-0" />
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        // Added `relative` for positioning the grid
        "relative h-[15rem] md:h-[20rem] rounded-xl z-40",
        className
      )}
    >
      {/* Grid background layer */}
      <div className="absolute inset-0 h-full w-full bg-black [background-image:linear-gradient(to_right,theme(colors.neutral.800)_1px,transparent_1px),linear-gradient(to_bottom,theme(colors.neutral.800)_1px,transparent_1px)] [background-size:2rem_2rem] z-0" />

      {/* Content (the animated logos) on top */}
